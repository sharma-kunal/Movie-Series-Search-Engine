...
//     // if(input.value == null || input.value == "" || currentString == input.value) {
//     //   console.log("Not making requests");
//     // } else {
...
function search(value) {
  url = "http://localhost:8090/api/movie/?name=" + value;
...
function callbackFunc(response) {
  ...
  for (let prop in response) {
    ...
    div2.addEventListener("click", function(){
      ...
      // window.scrollTo(0,0);
      console.log(name[0].getAttribute('id'));
      window.location.href = "http://localhost:8090/movie?id=" + name[0].getAttribute('id');
    });
